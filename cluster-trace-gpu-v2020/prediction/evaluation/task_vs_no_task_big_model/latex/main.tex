...
\pagebreak
  ...
  \label{sec:cpu-results}
    ...
    The LSTM \nameref{par:wt-model} tends under-allocate resources rather than over-allocate. This variant also has the lowest \emph{mean} and \emph{standard deviation} values, therefore, it is also the closest to the actual CPU utilization of all three variants for most of the values.
